...
def main() -> None:
    parser = argparse.ArgumentParser(description="Summarize Murata horizon-conv sweep results")
    parser.add_argument("--stamp", default=None, help="Sweep stamp under runs/murata_horizon_conv_sweep")
    ...
    print(f"=== Murata Horizon-Conv Sweep Report | stamp={stamp} ===")
